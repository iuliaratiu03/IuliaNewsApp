"""
Unit tests for IuliaBreakingNews RESTful API.
...
class SignalTests(TestCase):
    ...
    @patch("IuliaBreakingNews.signals._post_to_api")
    @patch("IuliaBreakingNews.signals._send_approval_emails")
    ...
    @patch("IuliaBreakingNews.signals.requests.post")
    @patch("IuliaBreakingNews.signals.send_mail")
